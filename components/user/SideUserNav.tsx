...
const SideUserNav = () => {
  ...
  const data = false;
  // const { data, error } = useSWR([`/api/user/company?q=${nick}`], fetcher);
  // console.log(data);
  ...
  return (
    <>
      {isBreakpoint ? (
        ...
        <div className="p-8 flex flex-end flex-col justify-between h-screen">
          <div className="px-4">
                ...
                <>
                  ...
                  >
                    <div className="flex items-center justify-start">
                      <CiShop size={32} />{' '}
                      <p className="px-2">Acessar Company</p>
                    </div>
                  </Link>
                </>
              ) : (
